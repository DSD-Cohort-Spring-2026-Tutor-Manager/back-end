...
@RestController("api/parent")
@RequiredArgsConstructor
public class ParentController {

    private final ParentService parentService;

    @Operation(summary = "Retrieves student sessions with progress",
            description = "This API retrieves the session information for a specific parent, including the " +
